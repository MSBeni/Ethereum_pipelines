...
INTO OUTFILE '/var/lib/mysql-files/location_wise_profit_2.csv' FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n';
...
INTO OUTFILE '/var/lib/mysql-files/store_wise_profit_2.csv' FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n';
